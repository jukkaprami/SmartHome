 ...
 * @param {str} apicall - An URL for WFS service and predefined query
 * @param {str} place - Name of the monitoring station
 * @param {str} parameters - Value of interest or comma separaed list of values
...
const getForecast = (apicall, place, parameters) => {
    let results = ''
    return results
}